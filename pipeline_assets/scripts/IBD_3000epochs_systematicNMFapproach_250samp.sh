...
#SBATCH --output=/blue/pbenos/tan.m/IBDCosMx_scRNAseq/Outputs250samp/cell2location_IBD_3000ep_systematicNMF_500samp.out
#SBATCH --error=/blue/pbenos/tan.m/IBDCosMx_scRNAseq/Outputs250samp/cell2location_IBD_3000ep_systematicNMF_500samp.err
#SBATCH --ntasks=1
...
# Run the R script
python /blue/pbenos/tan.m/IBDCosMx_scRNAseq/IBD_3000epochs_systematicNMFapproach_250samp.py
