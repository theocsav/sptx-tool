...
#SBATCH --output=/blue/pbenos/tan.m/IBDCosMx_scRNAseq/CosMx/Post-NMF_Analysis/MLP/IBD_MLP.out
#SBATCH --error=/blue/pbenos/tan.m/IBDCosMx_scRNAseq/CosMx/Post-NMF_Analysis/MLP/IBD_MLP.err
#SBATCH --ntasks=1
...
# Run the R script
python /blue/pbenos/tan.m/IBDCosMx_scRNAseq/IBD_MLP.py